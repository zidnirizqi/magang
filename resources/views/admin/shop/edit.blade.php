...
<head>
  ...
  <style>
    ...
    .image-preview { width: 150px; height: 150px; object-fit: cover; }
  </style>
</head>
<body>
  ...
  <div class="main-content">
    <div class="container-fluid py-4">
      ...
      <div class="row mb-4">
        <div class="col-md-8">
          <h1 class="display-6 fw-bold">✏️ Edit Product</h1>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" 
                       value="{{ old('price', $product->price) }}" placeholder="0" min="0" step="1000" required>
                @error('price')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="col-md-6">
                ...
                @if($product->image)
                  <div class="mt-2">
                    <img id="imagePreview" src="{{ $product->image_url }}" alt="Current Image" class="image-preview">
                    <p class="text-muted small mt-1">Current image (select new file to replace)</p>
                  </div>
                @else
